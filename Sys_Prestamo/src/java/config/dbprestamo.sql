...
(NOMBREi VARCHAR(45),APELLIDOSi VARCHAR(45),DNIi INTEGER,IDROLi INTEGER,CELULARi INTEGER,CORREOi VARCHAR(25))
BEGIN
START TRANSACTION;
INSERT INTO PERSONA(NOMBRE,APELLIDOS,DNI,IDROL,CELULAR,CORREO) VALUES(NOMBREi,APELLIDOSi,DNIi,IDROLi,CELULARi,CORREOi);
COMMIT;
