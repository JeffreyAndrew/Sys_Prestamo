                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a target="box" href="rc?gr=1&id=<%= u.getIdPersona()%>"><i class="fa fa-circle-o"></i> Lista de Reservas</a></li>
                            </ul>
                        </li>
                        <% }
                            if (irol == 1) {%>
                        ...
                        <li class="treeview">
                            <a href="#">
                                ...
                                <li class=""><a href="Esta?op=2" target="box"><i class="fa fa-circle-o"></i> Porcentaje </a></li>
                                <li><a href="Esta?op=1" target="box"><i class="fa fa-circle-o"></i>En intervalo de fechas</a></li>
                                <li><a href="Esta?op=3" target="box"><i class="fa fa-circle-o"></i> sin devolver</a></li>
                            </ul> 
                        </li>
